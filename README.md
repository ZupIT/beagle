...
It is also possible to create, test and update native application components and screen paths without any need to update the mobile application at the store (App Store or Play Store).
