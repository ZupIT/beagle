...
import br.com.zup.beagle.android.utils.ComponentConstant
...
class BeagleTextViewExtensionsKtTest : BaseComponentTest() {
    ...
    override fun setUp() {
        ...
        ComponentConstant.styleManager = styleManager
        ...
        every { anyConstructed<ComponentsViewFactory>().makeTextView(any(), STYLE_RES) } returns textView
