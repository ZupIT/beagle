...
class ListViewRecyclerAdapterTest {
    ...
    @MockK
    private lateinit var componentsViewFactory: ComponentsViewFactory
    @MockK
    ...
    fun setUp() {
        ...
        listViewRecyclerAdapter = ListViewRecyclerAdapter(ROWS, componentsViewFactory, RecyclerView.VERTICAL, rootView)

        every { componentsViewFactory.makeBeagleFlexView(any()) } returns view
