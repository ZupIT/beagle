...
#
#    Scenario: ListView 13 - Books ListView (infinite scroll): check onInit calls
...
#
#    Scenario: ListView 14 - Books ListView (infinite scroll): second set of books: scroll lower than 80% (threshold)
#        When I scroll to view with id booksList
#        And I scroll listView with id booksList to 79 percent
#        Then listView with id booksList should have exactly 5 items
#
#    Scenario: ListView 15 - Books ListView (infinite scroll): second set of books: scroll greater than 80% (threshold)
#        When I scroll to view with id booksList
#        And I scroll listView with id booksList to 81 percent
#        Then listView with id booksList should have exactly 10 items
#
#    Scenario: ListView 16 - Books ListView (infinite scroll): second set of books: check onInit calls
#        When I scroll to view with id booksList
#        And I scroll listView with id booksList to position 5
...
#    Scenario: ListView 18 - Books ListView (infinite scroll): no more data to load1
#        When I scroll to view with id booksList
#        And I scroll listView with id booksList to 81 percent
#        And I scroll listView with id booksList to 81 percent
...
#            | 33       | Name: Rúbeo Hagrid          | Book: Harry Potter and the Philosopher's Stone | Collection: Harry Potter           |
    ...
    Scenario Outline: ListView 21 - Books ListView: evaluates context correctly
