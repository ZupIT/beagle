...
internal object AndroidActionJsonAdapterFactory {
    ...
    fun make(): PolymorphicJsonAdapterFactory<Action> {
        ...
        factory = registerActions(factory, BEAGLE_NAMESPACE, BeagleEnvironment.beagleSdk.registeredInternalActions())
        factory = registerActions(factory, CUSTOM, BeagleEnvironment.beagleSdk.registeredActions())
        return factory
    }

    private fun registerActions(factory: PolymorphicJsonAdapterFactory<Action>,
                                appName: String,
