...
internal class BindCollectionAdapterFactory : JsonAdapter.Factory {
...
private class BindCollectionAdapter(
    ...
    override fun fromJson(reader: JsonReader): Bind<Collection<Any>>? {
        ...
        if (expression != null && expression is String && expression.isExpression()) {
            reader.skipValue()
            return Bind.Expression(expression,(type as Util.ParameterizedTypeImpl).rawType as Class<Collection<Any>>)
        }
