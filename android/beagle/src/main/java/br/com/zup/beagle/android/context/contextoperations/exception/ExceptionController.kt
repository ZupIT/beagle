...
import br.com.zup.beagle.android.context.contextoperations.exception.strategy.ExceptionParameterTypes
...
import br.com.zup.beagle.android.context.contextoperations.operationstrategy.array.ArrayOperationTypes
...
import br.com.zup.beagle.android.context.contextoperations.operationstrategy.string.StringOperationTypes
...
internal class ExceptionController {
    ...
    fun checkParameter(parameter: Parameter) {
        ...
        if (parameter.arguments.isNotEmpty()) {
            ...
            throw ExceptionFactory.createException(ExceptionParameterTypes.REQUIRED_ARGS, parameter.operation, parameter.arguments.size.toString())
        }
    }
