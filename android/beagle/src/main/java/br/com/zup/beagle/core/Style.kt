 ...
 *
 * @param backgroundColor Using a String parameter it sets the background color on this visual component.
 ...
 * @param margin effects the spacing around the outside of a node.
 ...
 * @param padding affects the size of the node it is applied to.
