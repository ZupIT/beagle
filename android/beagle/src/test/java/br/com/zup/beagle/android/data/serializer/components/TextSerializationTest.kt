...
class TextSerializationTest : BaseComponentSerializationTest() {

    @DisplayName("When try to deserialize json Text")
    @Nested
    inner class DeserializeJsonTextTest {

        @DisplayName("Then should return correct object")
        @Test
        fun testDeserializeJsonText() {
            // Given
            val expectedComponent = makeObjectText()
    ...
    @DisplayName("When try serialize object Text")
    @Nested
    inner class SerializeObjectTextTest {

        @DisplayName("Then should return correct json")
        @Test
        fun testSerializeJsonText() {
            // Given
            val expectedJson = makeTextJson().replace("\\s".toRegex(), "")
            val component = makeObjectText()
