...
class BeagleLoggerProxyTest {
    ...
    @Test
    fun debug_should_call_Log_w_if_is_enable() {
        // Given
        every { BeagleEnvironment.beagleSdk.config.logEnable } returns true

        // When
        BeagleLoggerProxy.debug(LOG)
    ...
    @Test
    fun debug_should_not_call_Log_w_if_is_not_enable() {
        // Given
        every { BeagleEnvironment.beagleSdk.config.logEnable } returns false
    ...
    @Test
    fun verbose_should_call_Log_w_if_is_enable() {
        // Given
        every { BeagleEnvironment.beagleSdk.config.logEnable } returns true

        // When
        BeagleLoggerProxy.verbose(LOG)
    ...
    @Test
    fun verbose_should_not_call_Log_w_if_is_not_enable() {
        // Given
        every { BeagleEnvironment.beagleSdk.config.logEnable } returns false
