...
class OperationsTest {
    ...
    fun insert_should_insert_element() {
        ...
        assertEquals(OperationType.TypeJsonArray(jsonArrayOf(9, 1, 2, 3)), insert.execute(OperationType.TypeJsonArray(jsonArrayOf(1, 2, 3)),
            OperationType.TypeNumber(9), OperationType.TypeNumber(0)))
        assertEquals(OperationType.TypeJsonArray(jsonArrayOf(1, 2, 3, 9)), insert.execute(OperationType.TypeJsonArray(jsonArrayOf(1, 2, 3)),
            OperationType.TypeNumber(9)))
    }

    @Test
    fun contains_should_check_if_contains_element() {
        val contains = ContainsOperation()
        assertEquals(OperationType.TypeBoolean(true),
            contains.execute(OperationType.TypeJsonArray(jsonArrayOf(1, 2, 3)), OperationType.TypeNumber(2)))
        assertEquals(OperationType.TypeBoolean(false),
            contains.execute(OperationType.TypeJsonArray(jsonArrayOf(1, 2, 3)), OperationType.TypeNumber(4)))
    }
//
//    @Test
