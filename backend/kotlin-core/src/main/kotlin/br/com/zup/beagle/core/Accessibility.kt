 ...
 *
 * @param accessible that will inform when the accessibilityLabel is available.
 *                   By default is kept as true and it indicates that the view is an accessibility element.
 * @param accessibilityLabel that will hold the textual information to be read by VoiceOver programs.
 *                           By enabling this, the VoiceOver will read this if a user selects this view,
 *                           them he will now where he is on the app.
 * @param isHeader that will inform when the view is heading for a section of content.
