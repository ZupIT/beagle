...
@DisplayName("Given a WidgetStyled")
internal class FunctionWidgetStyledTest {

    @DisplayName("When call this function")
    @Nested
    inner class WidgetStyledTest {

        @Test
        @DisplayName("Then should return the current widget with instance of style")
        fun testFunctionWidgetStyled() {
            // Given
            val backgroundColor = "#f1f1f1"

            // When
            val styleComponent = WidgetStyled(FlexComponentFake(), {
