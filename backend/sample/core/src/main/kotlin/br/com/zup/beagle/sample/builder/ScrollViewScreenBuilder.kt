...
import br.com.zup.beagle.sample.compose.sample.ComposeSampleScrollView
...
class ScrollViewScreenBuilder(val qaFlag: Boolean) : ScreenBuilder {
    override fun build() = Screen(
        ...
        child = if (qaFlag) ComposeScrollViewQuality else ComposeSampleScrollView
    )
}
