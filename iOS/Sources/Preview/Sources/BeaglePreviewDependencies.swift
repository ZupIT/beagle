...
struct BeaglePreviewDependencies: BeaglePreviewDependenciesProtocol {

    static let `default` = BeaglePreviewDependencies()

    var connection: WSConnectionHandler = SSConnectionHandler()
