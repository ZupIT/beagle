...
enum ScreenElements: String {
    ...
    var element: XCUIElement {
        ...
        case .BUTTON_DEFAULT, .BUTTON_WITH_STYLE, .BUTTON_WITH_APPEARANCE, .BUTTON_WITH_APPEARANCE_AND_STYLE, .OK_BUTTON, .CANCEL_BUTTON, .SEND_BUTTON, .PUSH_VIEW_REMOTE_BUTTON, .PUSH_VIEW_REMOTE_FAILURE_BUTTON, .PUSH_STACK_REMOTE_BUTTON, .PUSH_STACK_REMOTE_FAILURE_BUTTON:
