...
enum ScreenElements: String {
    ...
    case CLICK_SCROLLVIEW_HORIZONTAL = "Click to see the new text in horizontal"
    case CLICK_SCROLLVIEW_VERTICAL = "Click to see the new text in vertical"
