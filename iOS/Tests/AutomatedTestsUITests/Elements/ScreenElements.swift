...
enum ScreenElements: String {
    ...
    case PUSH_VIEW_REMOTE_BUTTON = "PushViewRemote"
    case PUSH_VIEW_REMOTE_EXPRESSION_BUTTON = "PushViewRemoteExpression"
    case PUSH_STACK_REMOTE_BUTTON = "PushStackRemote"
    case PUSH_STACK_REMOTE_EXPRESSION_BUTTON = "PushStackRemoteExpression"
    case PUSH_VIEW_REMOTE_FAILURE_BUTTON = "PushViewRemoteFailure"
    case PUSH_STACK_REMOTE_FAILURE_BUTTON = "PushStackRemoteFailure"
    case POP_VIEW_BUTTON = "PopView"
    case POP_TO_VIEW_BUTTON = "PopToView"
    case POP_STACK_BUTTON = "PopStack"
    
    var element: XCUIElement {
        switch self {
        case .MAIN_HEADER, .BUTTON_SCREEN_HEADER, .ACTION_CLICK_HEADER, .ACTION_CLICK_TEXT, .IMAGE_SCREEN_HEADER, .IMAGE_TEXT_1, .IMAGE_TEXT_2, .IMAGE_TEXT_3, .IMAGE_TEXT_4, .IMAGE_TEXT_5, .TABVIEW_SCREEN_HEADER, .TAB_1, .TAB_2, .TAB_3, .TAB_4, .TAB_1_TEXT, .TAB_2_TEXT, .TAB_3_TEXT, .TAB_4_TEXT, .TAB_1_TEXT_2, .TAB_2_TEXT_2, .TAB_3_TEXT_2, .TAB_4_TEXT_2, .PAGEVIEW_SCREEN_HEADER, .PAGE_1_TEXT, .PAGE_2_TEXT, .PAGE_3_TEXT, .SCROLLVIEW_SCREEN_HEADER, .SCROLLVIEW_TEXT_1, .SCROLLVIEW_TEXT_2, .LISTVIEW_SCREEN_HEADER, .STATIC_LISTVIEW_TEXT_1, .STATIC_LISTVIEW_TEXT_2, .DYNAMIC_LISTVIEW_TEXT_1, .DYNAMIC_LISTVIEW_TEXT_2, .TOUCHABLE_SCREEN_HEADER, .TOUCHABLE_TEXT_1, .TOUCHABLE_TEXT_2, .TOUCHABLE_TEXT_3, .TOUCHABLE_TEXT_4, .SIMPLE_FORM_SCREEN_HEADER, .SIMPLE_FORM_TITLE, .NAVIGATION_SCREEN_TITLE, .SAMPLE_NAVIGATION_SCREEN_TITLE, .SEND_REQUEST_SCREEN_TITLE:
            return XCUIApplication().staticTexts[self.rawValue]
            
        case .BUTTON_DEFAULT, .BUTTON_WITH_STYLE, .BUTTON_WITH_APPEARANCE, .BUTTON_WITH_APPEARANCE_AND_STYLE, .OK_BUTTON, .CANCEL_BUTTON, .SEND_BUTTON, .PUSH_VIEW_REMOTE_BUTTON, .PUSH_VIEW_REMOTE_EXPRESSION_BUTTON, .PUSH_VIEW_REMOTE_FAILURE_BUTTON, .PUSH_STACK_REMOTE_BUTTON, .PUSH_STACK_REMOTE_EXPRESSION_BUTTON, .PUSH_STACK_REMOTE_FAILURE_BUTTON, .POP_VIEW_BUTTON, .POP_TO_VIEW_BUTTON, .POP_STACK_BUTTON:
