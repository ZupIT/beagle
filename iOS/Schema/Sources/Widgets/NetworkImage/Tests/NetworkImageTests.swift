...
class NetworkImageTests: XCTestCase {
    ...
    func test_whenDecodingJson_thenItShouldReturnNetworkImageWithPlaceholder() throws {
        let component: NetworkImage = try componentFromJsonFile(fileName: "NetworkImageWithPlaceholder")
        assertSnapshot(matching: component, as: .dump)
    }
}
