...
extension String {
    ...
    static let NAVIGATE_STEP1_ENDPOINT = "navigateScreenStep1"
    static let NAVIGATE_STEP2_ENDPOINT = "navigateScreenStep2"
    static let TEXT_FORM_ENDPOINT = "https://t001-2751a.firebaseapp.com/action/shownativedialog.json"
    static let TEXT_LAZY_COMPONENTS_ENDPOINT = "https://run.mocky.io/v3/bd78fba6-da3d-4cb3-8807-85923366fe13"
