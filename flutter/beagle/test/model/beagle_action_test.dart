...
void main() {
  group('Given a BeagleAction', () {
    const actionType = 'beagle:alert';
    const actionMessage = 'Example button.';
    final beagleAction = BeagleAction({
      '_beagleAction_': 'beagle:alert',
      'message': 'Example button.',
    });
    group('When getType is called', () {
      test('Then should return the correct type', () {
        final result = beagleAction.getType();
